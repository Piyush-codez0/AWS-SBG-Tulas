...
export default function CircularTestimonialsDemoPage() {
  return (
    <main className="min-h-screen bg-bg p-8 space-y-12">
      {/* Light testimonials section */}
      <div className="bg-[#f7f7fa] p-8 md:p-20 rounded-2xl min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative">
        <div
      ...
      <div className="bg-[#060507] p-8 md:p-16 rounded-2xl min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative">
        <div
          className="items-center justify-center relative flex w-full"
