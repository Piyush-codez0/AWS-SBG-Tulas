...
export function TeamLeadership() {
  ...
  return (
    <section ref={sectionRef} id="leadership" className="relative pt-24 md:pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-content mx-auto">
      ...
      <div className="relative max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="gsap-reveal-lead relative z-10 text-[11px] uppercase tracking-[0.16em] text-muted font-mono">
          Leadership & Vision
        </p>
        <h2 className="gsap-reveal-lead relative z-10 mt-4 font-display text-[32px] sm:text-[40px] font-semibold tracking-tight text-text-primary">
          Community{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        {LEADERSHIP_TEAM.map((leader: LeadershipMember, idx: number) => {
          ...
          return (
            <div
              key={leader.id}
              className="gsap-reveal-lead relative rounded-2xl bg-bg-card border border-border p-6 sm:p-8 flex flex-col justify-between overflow-hidden group hover:border-primary/40 transition-all duration-300 shadow-xl"
            >
              {/* Top Accent Glow */}
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-primary-light/40 to-transparent" />
              <div className="absolute top-4 right-6 font-mono text-[10px] uppercase tracking-widest text-muted">
                0{idx + 1} // LEADERSHIP
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                    ...
                    <div
                      className={`relative overflow-hidden bg-bg-surface border border-primary/30 shadow-lg transition-transform duration-300 group-hover/photo:scale-105 ${
                        isFaculty
                          ...
                          : "w-28 h-36 sm:w-32 sm:h-40 rounded-2xl"
                      }`}
                    >
                      <Image
                        src={leader.avatar}
                  ...
                  <div className="text-center sm:text-left space-y-2 pt-1">
                    <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary-light text-xs font-mono">
              ...
              <div className="flex items-center gap-3 pt-6 mt-6 border-t border-border/80">
