...
const HUB_TOPICS = [
  ...
  ), accent: "text-primary-light bg-primary/10", border: "border-primary/30 hover:border-primary/60 hover:shadow-[0_6px_20px_-6px_rgba(124,58,237,0.15)]" },
  ...
  ), accent: "text-accent bg-accent/10", border: "border-accent/30 hover:border-accent/60 hover:shadow-[0_6px_20px_-6px_rgba(6,182,212,0.15)]" },
  { label: "Hands-on Labs", icon: (
    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>
    </svg>
  ), accent: "text-success bg-success/10", border: "border-success/30 hover:border-success/60 hover:shadow-[0_6px_20px_-6px_rgba(34,197,94,0.15)]" },
  { label: "Certification Guides", icon: (
    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/>
    </svg>
  ), accent: "text-warning bg-warning/10", border: "border-warning/30 hover:border-warning/60 hover:shadow-[0_6px_20px_-6px_rgba(245,158,11,0.15)]" },
  { label: "Project Tutorials", icon: (
    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18M9 21V9"/>
    </svg>
  ), accent: "text-info bg-info/10", border: "border-info/30 hover:border-info/60 hover:shadow-[0_6px_20px_-6px_rgba(14,165,233,0.15)]" },
  ...
  ), accent: "text-error bg-error/10", border: "border-error/30 hover:border-error/60 hover:shadow-[0_6px_20px_-6px_rgba(239,68,68,0.15)]" },
];
